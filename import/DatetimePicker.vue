      ...
      <v-card-text class="px-0 py-0">
        <v-tabs fixed-tabs v-model="activeTab">
          ...
          <v-tab-item key="calendar">
            <v-date-picker v-model="date" v-bind="datePickerProps" @input="showTimePicker" full-width :day-format="date => new Date(date).getDate()"></v-date-picker>
          </v-tab-item>
